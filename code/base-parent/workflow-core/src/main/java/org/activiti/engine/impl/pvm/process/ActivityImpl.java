...
public class ActivityImpl extends ScopeImpl implements PvmActivity {
  ...
  //Dynamic OutgoingTransitions for jump flow
  protected List<TransitionImpl> dynOutgoingTransitions = new ArrayList<TransitionImpl>();
  
  public ActivityImpl(String id, ProcessDefinitionImpl processDefinition) {
    super(id, processDefinition);
  }

  public TransitionImpl createDynOutgoingTransition() {
	  TransitionImpl transition = new TransitionImpl(null, processDefinition);
	    transition.setSource(this);
	    dynOutgoingTransitions.add(transition);
	    
	    return transition;
  }
  
  @SuppressWarnings({ "unchecked", "rawtypes" })
  public List<PvmTransition> getDynOutgoingTransitions() {
    return (List) dynOutgoingTransitions;
  }
