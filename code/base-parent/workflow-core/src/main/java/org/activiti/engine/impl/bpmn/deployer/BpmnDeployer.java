...
public class BpmnDeployer implements Deployer {
	...
	private static final Logger LOG = Logger.getLogger(BpmnDeployer.class
			.getName());;

	public static final String BPMN_RESOURCE_SUFFIX = "bpmn20.xml";
	public static final String BPMN_RESOURCE_SUFFIX2 = "BPMN";
	public static final String BPMN_RESOURCE_SUFFIX3 = "bpmn";
	public static final String[] DIAGRAM_SUFFIXES = new String[] { "png",
			"jpg", "gif", "svg" };
	...
	public void deploy(DeploymentEntity deployment) {
		...
		for (String resourceName : resources.keySet()) {
			...
			if (resourceName.endsWith(BPMN_RESOURCE_SUFFIX)
					|| resourceName.endsWith(BPMN_RESOURCE_SUFFIX2)
					|| resourceName.endsWith(BPMN_RESOURCE_SUFFIX3)) {
						...
						try {
							...
							if (!ge.isHeadlessInstance()) {
								...
								LOG.log(Level.WARNING,
										"Cannot generate process diagram while running in AWT headless-mode");
							}
...
//	}
	...
	protected String getProcessImageResourceName(String bpmnFileResource,
		...
		String bpmnFileResourceBase = getBpmnFileResourceBase(bpmnFileResource);//liyb add
		return bpmnFileResourceBase + processKey + "." + diagramSuffix;
	}

	/**
	 * //liyb add 2012-08-12
	 * @param bpmnFileResource
	 * @return
	 */
	private String getBpmnFileResourceBase(String bpmnFileResource) {
		if (bpmnFileResource.endsWith(BPMN_RESOURCE_SUFFIX)) {
			return bpmnFileResource
					.substring(0, bpmnFileResource.length() - 10);
		} else if (bpmnFileResource.endsWith(BPMN_RESOURCE_SUFFIX2)
				|| bpmnFileResource.endsWith(BPMN_RESOURCE_SUFFIX3)) {
			return bpmnFileResource.substring(0, bpmnFileResource.length() - 4);
		}
		return null;
	}
