 ...
 * @author Joram Barrez
 */
public class ParallelMultiInstanceBehavior extends ZMultiInstanceActivityBehavior {
   ...
   */
   protected void createInstances(ActivityExecution execution) throws Exception {
    ...
    for (int loopCounter=0; loopCounter<nrOfInstances; loopCounter++) {
      ...
      concurrentExecution.setVariableLocal("_designate_assgin", getUsers().get(loopCounter));
