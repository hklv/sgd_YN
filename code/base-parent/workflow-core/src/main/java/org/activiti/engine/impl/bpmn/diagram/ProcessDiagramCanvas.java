...
public class ProcessDiagramCanvas {
  ...
  protected static Image RULE_IMAGE;
  ...
  static {
    try {
      ...
      RULE_IMAGE =  ImageIO.read(ReflectUtil.getResourceAsStream("org/activiti/engine/impl/bpmn/deployer/rule.png"));
  ...
  public void drawBusinessRuleTask(String name, int x, int y, int width, int height) {
	    drawTask(name, x, y, width, height);
	    g.drawImage(RULE_IMAGE, x + 7, y + 7, ICON_SIZE, ICON_SIZE, null);
	  }
