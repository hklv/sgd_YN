...
public class BooleanOperations {
	...
	public static final boolean in(TypeConverter converter, Object o1, Object o2) {
		if (o1 == o2) {
			return true;
		}
		if (o1 == null || o2 == null) {
		...
		if (t1 == String.class || t2 == String.class) {
			...
			String t1value = converter.convert(o1, String.class);
			String t2value = converter.convert(o2, String.class);
			
			String[] t2values = t2value.split(",");
			for(int i = 0; i < t2values.length; i++)
			{
				if(t1value.equals(t2values[i]))
				{
					return true;
				}
			}
	...
	public static final boolean notin(TypeConverter converter, Object o1, Object o2) {
		if (o1 == o2) {
			return true;
		}
		if (o1 == null || o2 == null) {
