...
public class AstBinary extends AstRightValue {
	...
	public static final Operator IN = new SimpleOperator() {
		@Override public Object apply(TypeConverter converter, Object o1, Object o2) { return BooleanOperations.in(converter, o1, o2); }
		@Override public String toString() { return "in"; }
	};
	
	public static final Operator NOTIN = new SimpleOperator() {
		@Override public Object apply(TypeConverter converter, Object o1, Object o2) { return BooleanOperations.notin(converter, o1, o2); }
		@Override public String toString() { return "notin"; }
	};
