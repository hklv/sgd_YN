package com.ztesoft.uboss.bpm.setup.dao.postgresqlimpl;
...
public class FlowManagerDAOPostgreSQL extends FlowManagerDAO {
    ...
    public List<ProcessDefView> qryAllSimProcessVersion(DynamicDict dynamicDict)
        ...
        qrySql.append(" WHERE A.PROC_TEMP_ID = B.PROC_TEMP_ID AND B.VER_STATE = 'S' AND B.STATE = 'A' AND B.EFFECTIVE_DATE < NOW() AND B.EXPIRED_DATE>NOW()");
