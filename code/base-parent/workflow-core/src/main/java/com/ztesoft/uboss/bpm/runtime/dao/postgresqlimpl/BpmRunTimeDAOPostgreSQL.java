package com.ztesoft.uboss.bpm.runtime.dao.postgresqlimpl;
...
public class BpmRunTimeDAOPostgreSQL extends BpmRunTimeDAO {
	...
	public List<TaskListInfo> qryTaskList(String processInstanceId)
		...
		String sql = "SELECT A.TASK_LIST_ID, A.TASK_NAME TASK_LIST_NAME,A.TASK_RESULT ,C.FORM_ID, A.TASK_TYPE, A.STATE TASK_STATE,"
				...
				+ " WHERE A.PROC_INST_ID = ? and a.HOLDER_ID=e.HOLDER_ID  ORDER BY to_number(A.ACT_INST_ID,'999999999999999'),A.CREATE_DATE";
