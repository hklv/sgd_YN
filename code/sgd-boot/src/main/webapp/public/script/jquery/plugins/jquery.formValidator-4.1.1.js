...
$.formValidator = 
{
	...
	initConfig : function(controlOptions)
	{
		...
		$.ajax({async:false,type: "GET",url: settings.theme+"/js/theme.js",dataType: "script",
		...
		if($.browser.msie)
		{
			...
			css.rel="stylesheet";
			css.type="text/css";
			css.href=settings.theme+"/style/style.css";
		...
		else
		{
			...
			var styCss = "@import url('"+settings.theme+"/style/style.css');";
