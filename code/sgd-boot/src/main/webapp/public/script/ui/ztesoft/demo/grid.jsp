...
var cols = [ {display : '地区ID', name : 'AREA_ID',	width : 80,	sortable : true, align : 'center',hide :false}, 
	...
	var grid2;
	var ifUsePage = false; //是否翻页
	$(function() {
		
		var gridheight = $("#grid2div").height();
	...
	function setColumnWidth(){
		$("#grid2").datagrid("getPanel").removeClass('lines-both lines-no lines-right lines-bottom').addClass("lines-bottom");
	}
...
<body>
		...
		<table border=0 cellpadding=0 cellspacing=0>
						...
						<tr>
							<td colspan="4" align="center">
								...
								<input type="button" onclick="setColumnWidth();" value="设置列宽" class="button"/>
	...
	<div class="" id="divStaffDetail" style="width: 90%;height: 80%">
